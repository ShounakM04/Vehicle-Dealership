...
const Dashboard = () => {
  ...
  const fetchTotalSellingPrice = async () => {
    try {
      const response = await axios.get(
        "https://nikhilmotors.com/api/dashboard/total-selling-price",
        {
          headers: {
  ...
  const downloadLogFile = async () => {
    try {
      const response = await fetch("https://nikhilmotors.com/api/logs/download", {
        method: "GET",
        headers: {
  ...
  const fetchCarDetails = async () => {
    try {
      ...
      const response = await axios.get("https://nikhilmotors.com/api/dashboard", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
        params,
  ...
  const fetchMonthlyCosts = async () => {
    try {
      const response = await axios.get(
        "https://nikhilmotors.com/api/miscellaneous-costs/current-month",
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("authToken")}`,
          },
  ...
  const fetchAccountDetails = async () => {
    try {
      const response = await axios.get("https://nikhilmotors.com/api/accountDetails", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
      });
  ...
  const fetchProfit = async () => {
    ...
    try {
      const response = await axios.get(`https://nikhilmotors.com/api/profits/monthly`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('authToken')}`,
        }
      })
