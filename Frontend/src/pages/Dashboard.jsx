    ...
    <div className="min-h-screen bg-blue-100 flex flex-col lg:flex-row">
      ...
      <div className="flex-1 p-5 lg:p-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
          ...
          <div className="bg-orange-300 p-3 rounded text-white min-h-4 cursor-pointer hover:bg-orange-400 transition-all transform hover:scale-105 active:scale-95">
            <p>Total Sold Vehicles Cost</p>
            <p className="text-lg font-bold">₹{totalSellingPrice}</p> {/* Display total selling price */}
          </div>
          <div
            className="bg-green-400 p-3 rounded text-white min-h-4 "
