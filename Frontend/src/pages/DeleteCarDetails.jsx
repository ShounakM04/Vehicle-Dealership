...
function DeleteCarDetails() {
  ...
  const fetchCarDetails = async (currDeleteId) => {
    ...
    try {
      const response = await axios.get(`https://hg6el8z6a5.execute-api.ap-south-1.amazonaws.com/default/${currDeleteId}`);
  ...
  const deleteEntry = async () => {
      ...
      try {
        ...
        const response = await axios.delete(`https://hg6el8z6a5.execute-api.ap-south-1.amazonaws.com/default/delete`, {
          params: {
