...
const EditVehicleDetailsForm = () => {
  ...
  useEffect(() => {
    const fetchCarDetails = async () => {
      try {
        ...
        const { car, images, insurance, owner, finance } = response.data;
  ...
  const handleVehicleDetailsEdit = async (newValue, fieldToEdit) => {
    ...
    if (
      fieldToEdit == "insurancecompany" ||
      fieldToEdit == "insurancenumber" ||
      fieldToEdit == "insurancestartdate" ||
      fieldToEdit == "insuranceenddate" ||
      fieldToEdit == "insurancetenure"
    ) {
      tablename = "carinsurance";
    }
    if (
      fieldToEdit == "ownername" ||
      fieldToEdit == "ownerphone" ||
      fieldToEdit == "owneremail" ||
    ...
    if (
      ...
      fieldToEdit == "manager_name1" ||
      fieldToEdit == "contact1" ||
      fieldToEdit == "manager_name2" ||
      fieldToEdit == "contact2"
    ) {
      tablename = "finance";
    }
    try {
  ...
  return (
    <div className="container mx-auto pl-16 pr-16 pb-16 pt-8">
      ...
      <div>
        <h1 className="text-xl font-bold mb-2 mt-6 ">
          Vehicle Details : Reg No : {id}
        </h1>
        <div className="flex flex-wrap gap-4">
          <div className="w-full md:w-[49%]">
            ...
            <div className="relative w-full">
              <input
                ...
                value={
                  editableFields.carname
                    ? inputValue
                    : vehicleData.vehicleDetails.carname
                }
              ...
              <button
                ...
                onClick={() =>
                  setEditableFields({ ...editableFields, carname: true })
                }
              >
          ...
          <div className="w-full md:w-[49%]">
            ...
            <div className="relative w-full">
              <input
                ...
                value={
                  editableFields.carcompany
                    ? inputValue
                    : vehicleData.vehicleDetails.carcompany
                }
              ...
              <button
                className="absolute right-2 top-1/2 transform -translate-y-1/2"
                onClick={() =>
                  setEditableFields({ ...editableFields, carcompany: true })
                }
              >
                <i className="fas fa-pencil-alt"></i>
              </button>
          ...
          <div className="w-full md:w-[49%]">
            ...
            <div className="relative w-full">
              <input
                ...
                value={
                  editableFields.carcolor
                    ? inputValue
                    : vehicleData.vehicleDetails.carcolor
                }
              ...
              <button
                className="absolute right-2 top-1/2 transform -translate-y-1/2"
                onClick={() =>
                  setEditableFields({ ...editableFields, carcolor: true })
                }
              >
                <i className="fas fa-pencil-alt"></i>
              </button>
          ...
          <div className="w-full md:w-[49%]">
            ...
            <div className="relative w-full">
              ...
              <button
                className="absolute right-2 top-1/2 transform -translate-y-1/2"
                onClick={() =>
                  setEditableFields({ ...editableFields, fuel: true })
                }
              >
                <i className="fas fa-pencil-alt"></i>
              </button>
                  ...
                  <input
                    ...
                    value={
                      editableFields.vehiclebuyprice
                        ? inputValue
                        : vehicleData.vehicleDetails.vehiclebuyprice
                    }
          ...
          <div className="w-full md:w-[49%]">
            <label
              htmlFor="vehiclesellprice"
              className="block text-gray-700 text-sm font-bold mb-2"
            >
              Vehicle Selling Price (Display Price)
            </label>
            <div className="relative w-full">
              <input
                type="text"
                ...
                value={
                  editableFields.vehiclesellprice
                    ? inputValue
                    : vehicleData.vehicleDetails.vehiclesellprice
                }
              ...
              <textarea
                ...
                value={
                  editableFields.description
                    ? inputValue
                    : vehicleData.vehicleDetails.description
                }
      ...
      <div>
              ...
              <input
                ...
                value={
                  editableFields.insurancecompany
                    ? inputValue
                    : vehicleData.vehicleDetails.insurancecompany
                }
              ...
              <input
                ...
                value={
                  editableFields.insurancenumber
                    ? inputValue
                    : vehicleData.vehicleDetails.insurancenumber
                }
              ...
              <input
                ...
                value={
                  editableFields.insuranceenddate
                    ? inputValue
                    : vehicleData.vehicleDetails.insuranceenddate?.slice(0, 10)
                }
              ...
              <input
                ...
                value={
                  editableFields.insurancetenure
                    ? inputValue
                    : vehicleData.vehicleDetails.insurancetenure
                }
            ...
            <div className="w-full md:w-[49%]">
              ...
              <div className="relative w-full">
                <input
                  ...
                  value={
                    editableFields.ownername
                      ? inputValue
                      : vehicleData.vehicleDetails.ownername
                  }
                ...
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, ownername: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
            ...
            <div className="w-full md:w-[49%]">
              ...
              <div className="relative w-full">
                <input
                  ...
                  value={
                    editableFields.ownerphone
                      ? inputValue
                      : vehicleData.vehicleDetails.ownerphone
                  }
                ...
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, ownerphone: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
            ...
            <div className="w-full md:w-[49%]">
              ...
              <div className="relative w-full">
                <input
                  ...
                  value={
                    editableFields.owneremail
                      ? inputValue
                      : vehicleData.vehicleDetails.owneremail
                  }
                ...
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, owneremail: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
            ...
            <div className="w-full md:w-[49%]">
              ...
              <div className="relative w-full">
                <input
                  ...
                  value={
                    editableFields.owneraddress
                      ? inputValue
                      : vehicleData.vehicleDetails.owneraddress
                  }
                ...
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, owneraddress: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
        ...
        <div>
          <h1 className="text-xl font-bold mb-2 mt-6 ">Finance Details</h1>
          <div className="flex flex-wrap gap-4">
            <div className="w-full md:w-[49%]">
              <label
              ...
              <div className="relative w-full">
                <input
                  ...
                  value={
                    editableFields.company_name
                      ? inputValue
                      : vehicleData.vehicleDetails.company_name
                  }
                ...
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, company_name: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
                ...
                {editableFields.company_name && (
                  <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex space-x-2">
                    <button
                      onClick={() =>
                        handleVehicleDetailsEdit(inputValue, "company_name")
                      }
                      className={`bg-green-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                    ...
                    <button
                      onClick={() => handleCancelEdit("company_name")}
                      className={`bg-red-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                      CANCEL
            ...
            <div className="w-full md:w-[49%]">
              ...
              <div className="relative w-full">
                <input
                  ...
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  value={
                    editableFields.branch_name
                      ? inputValue
                      : vehicleData.vehicleDetails.branch_name
                  }
                  readOnly={!editableFields.branch_name}
                  onChange={handleInputChange}
                />
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, branch_name: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
                ...
                {editableFields.branch_name && (
                  <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex space-x-2">
                    <button
                      onClick={() =>
                        handleVehicleDetailsEdit(inputValue, "branch_name")
                      }
                      className={`bg-green-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                    ...
                    <button
                      onClick={() => handleCancelEdit("branch_name")}
                      className={`bg-red-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                      CANCEL
            ...
            <div className="w-full md:w-[49%]">
              ...
              <div className="relative w-full">
                <input
                  ...
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  value={
                    editableFields.manager_name1
                      ? inputValue
                      : vehicleData.vehicleDetails.manager_name1
                  }
                  readOnly={!editableFields.manager_name1}
                  onChange={handleInputChange}
                />
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, manager_name1: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
                ...
                {editableFields.manager_name1 && (
                  <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex space-x-2">
                    <button
                      onClick={() =>
                        handleVehicleDetailsEdit(inputValue, "manager_name1")
                      }
                      className={`bg-green-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                    ...
                    <button
                      onClick={() => handleCancelEdit("manager_name1")}
                      className={`bg-red-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                      CANCEL
            ...
            <div className="w-full md:w-[49%]">
              ...
              <div className="relative w-full">
                <input
                  ...
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  value={
                    editableFields.contact1
                      ? inputValue
                      : vehicleData.vehicleDetails.contact1
                  }
                  readOnly={!editableFields.contact1}
                  onChange={handleInputChange}
                />
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, contact1: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
                ...
                {editableFields.contact1 && (
                  <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex space-x-2">
                    <button
                      onClick={() =>
                        handleVehicleDetailsEdit(inputValue, "contact1")
                      }
                      className={`bg-green-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                    ...
                    <button
                      onClick={() => handleCancelEdit("contact1")}
                      className={`bg-red-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                      CANCEL
            ...
            <div className="w-full md:w-[49%]">
              ...
              <div className="relative w-full">
                <input
                  ...
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  value={
                    editableFields.manager_name2
                      ? inputValue
                      : vehicleData.vehicleDetails.manager_name2
                  }
                  readOnly={!editableFields.manager_name2}
                  onChange={handleInputChange}
                />
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, manager_name2: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
                ...
                {editableFields.manager_name2 && (
                  <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex space-x-2">
                    <button
                      onClick={() =>
                        handleVehicleDetailsEdit(inputValue, "manager_name2")
                      }
                      className={`bg-green-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                    ...
                    <button
                      onClick={() => handleCancelEdit("manager_name2")}
                      className={`bg-red-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                      CANCEL
            ...
            <div className="w-full md:w-[49%]">
              ...
              <div className="relative w-full">
                <input
                  ...
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  value={
                    editableFields.contact2
                      ? inputValue
                      : vehicleData.vehicleDetails.contact2
                  }
                  readOnly={!editableFields.contact2}
                  onChange={handleInputChange}
                />
                <button
                  className="absolute right-2 top-1/2 transform -translate-y-1/2"
                  onClick={() =>
                    setEditableFields({ ...editableFields, contact2: true })
                  }
                >
                  <i className="fas fa-pencil-alt"></i>
                </button>
                ...
                {editableFields.contact2 && (
                  <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex space-x-2">
                    <button
                      onClick={() =>
                        handleVehicleDetailsEdit(inputValue, "contact2")
                      }
                      className={`bg-green-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                    ...
                    <button
                      onClick={() => handleCancelEdit("contact2")}
                      className={`bg-red-500 text-white py-1 px-3 rounded ${wait ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
                      CANCEL
