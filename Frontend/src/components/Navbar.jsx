        ...
        <div className="flex p-2 bg-blue-500 items-center md:hidden">
          ...
          <div>
            <div className="flex items-center">
              ...
              <a href="tel:+917058600679" className="font-medium ml-2 hover:underline text-black">
                General: +91 7058600679
              </a>
            </div>
            <a href="tel:+919272111777" className="font-medium mt-1 block hover:underline text-black">
